...
namespace MolecularMachines.Framework.Model
{
    ...
    public class Element
    {
        ...
        private Element(string symbol, float radius, float vdwRadius, float mass)
        {
            ...
            elements.Add(symbol.ToLower(), this);
        }
        ...
        {
            if (obj == this) { return true; } // speed optimization, because it will be often the case
            ...
            return
                ...
                (this.VdWRadius == other.VdWRadius) &&
        ...
        {
            Element element;
            if (elements.TryGetValue(symbol.ToLower(), out element))
            {
                return element;
            }
            else
        ...
        /// Iron
        /// </summary>
        public static readonly Element Fe = new Element("Fe", 140 / 1000f, 152 / 1000f, 55.845f);
    }
}
